...
public class TwoDimArrayPractice extends JFrame
{
   ...
   public void printArray( )
   {
       for ( int row = 0; row < intArray.length; row++ )
       {
           ...
           for ( int column = 0; column < intArray[row].length; column++ )
           {
               ...
               animate( row, column ); // Animate the printing process
           }
           System.out.println( );
       }
   }
   ...
   */
   public void setValues( int value, int row )
   {
       for ( int column = 0; column < intArray[row].length; column++ )
       {
           ...
           animate( row, column ); // Animate the setting of values
       }
   }
   ...
   */
   ...
   {
       int minimum = Integer.MAX_VALUE; // Start with the largest possible value
       ...
       for ( int row = 0; row < intArray.length; row++ )
       {
           ...
           animate( row, column, minimum ); // Animate the process with the current minimum
       }
   ...
   public int countFound( int value )
   {
       ...
       for ( int row = 0; row < intArray.length; row++ )
       {
           for ( int column = 0; column < intArray[row].length; column++ )
           {
               ...
               animate( row, column, count ); // Animate the frequency counting process
           }
       }
